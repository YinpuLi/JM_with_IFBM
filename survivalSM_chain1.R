...
re_stoc <- readRDS(paste0("longitudinalSM_random_terms_estimates_simulation",as.numeric(as.numeric(args[1])),".rds"))
...
saveRDS(parameters, paste0("survivalSM_simulation", as.numeric(args[1]), "_chain1.rds"))

updates <- data.frame(update_gamma_h01,update_gamma_h02, update_beta1, update_gam1)

saveRDS(updates, paste0("survivalSM_simulation", as.numeric(args[1]), "_updates_chain1.rds"))

...
system.time(for(i in 2:niter)
{
  ...
  if(i %% 1000 == 0)
  {
    saveRDS(data.frame(alpha0, alpha1, sigmasq, tausq, kappa, H), paste0("longitudinalSM_simulation", as.numeric(args[1]), "_chain2.rds"))
  }
  if(i %% 100 == 0)
  {
...
saveRDS(parameters, paste0("longitudinalSM_simulation", as.numeric(args[1]), "_chain2.rds"))
saveRDS(random_terms, paste0("longitudinalSM_simulation", as.numeric(args[1]), "_randomterms_chain2.rds"))
saveRDS(updates, paste0("longitudinalSM_simulation", as.numeric(args[1]), "_updates_chain2.rds"))
